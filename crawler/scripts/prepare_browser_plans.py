...
for id,file in [('ggzy-chongqing','browser_plan.json'),('aggregator_jianyu360','jianyu_plan.json'),('ggzy-jiangxi','epoint-ggzy-jiangxi-plan.json')]:
...
print('已生成重庆、剑鱼和江西原式种子计划；待执行不计完成。')
